...
#
# Generated by export_simulation on Tue Aug 25 15:04:27 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './XDOM_DDR3_PG.sh' script.

./XDOM_DDR3_PG.sh -reset_run
...
./XDOM_DDR3_PG.sh -noclean_files

For more information on the script, please type './XDOM_DDR3_PG.sh -help'.
