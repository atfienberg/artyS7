...
#
# Generated by export_simulation on Wed Aug 26 13:55:40 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './REFCLK_MMCM.sh' script.

./REFCLK_MMCM.sh -reset_run
...
./REFCLK_MMCM.sh -noclean_files

For more information on the script, please type './REFCLK_MMCM.sh -help'.
