...
#
# Generated by export_simulation on Thu Aug 27 13:24:16 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './HBUF_DDR3_PG.sh' script.

./HBUF_DDR3_PG.sh -reset_run
...
./HBUF_DDR3_PG.sh -noclean_files

For more information on the script, please type './HBUF_DDR3_PG.sh -help'.
