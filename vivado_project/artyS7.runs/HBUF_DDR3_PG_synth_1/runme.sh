...
HD_PWD='C:/Users/atfie/IceCube/artyS7/vivado_project/artyS7.runs/HBUF_DDR3_PG_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HBUF_DDR3_PG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HBUF_DDR3_PG.tcl
