...
HD_PWD='C:/Users/atfie/IceCube/artyS7/vivado_project/artyS7.runs/DIST_BUFFER_32_22_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DIST_BUFFER_32_22.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DIST_BUFFER_32_22.tcl
