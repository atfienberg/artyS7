...
HD_PWD='C:/Users/atfie/IceCube/artyS7/vivado_project/artyS7.runs/REFCLK_MMCM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log REFCLK_MMCM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source REFCLK_MMCM.tcl
