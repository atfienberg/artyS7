...
HD_PWD='C:/Users/atfie/IceCube/artyS7/vivado_project/artyS7.runs/HBUF_RDOUT_DPRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HBUF_RDOUT_DPRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HBUF_RDOUT_DPRAM.tcl
