...
HD_PWD='C:/Users/atfie/IceCube/artyS7/vivado_project/artyS7.runs/FIFO_256_80_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_256_80.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_256_80.tcl
