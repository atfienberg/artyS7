...
HD_PWD='C:/Users/atfie/IceCube/artyS7/vivado_project/artyS7.runs/XDOM_DDR3_PG_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XDOM_DDR3_PG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XDOM_DDR3_PG.tcl
